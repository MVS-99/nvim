...
<a href="https://dotfyle.com/MVS-99/nvim"><img src="https://dotfyle.com/MVS-99/nvim/badges/plugin-manager?style=flat" /></a>
...
```sh
git clone git@github.com:MVS-99/nvim ~/.config/MVS-99/nvim
NVIM_APPNAME=MVS-99/nvim/ nvim --headless +"Lazy! sync" +qa
```

Open Neovim with this config:

```sh
NVIM_APPNAME=MVS-99/nvim/ nvim
```
...
+ [TobinPalmer/Tip.nvim](https://dotfyle.com/plugins/TobinPalmer/Tip.nvim)
